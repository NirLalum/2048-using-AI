...
if __name__ == "__main__":
    ...
    move_players = {'GreedyMovePlayer': algorithms.GreedyMovePlayer,
                    'ImprovedGreedyMovePlayer': algorithms.ImprovedGreedyMovePlayer,
                    'MiniMaxMovePlayer': algorithms.MiniMaxMovePlayer,
                    'ABMovePlayer': algorithms.ABMovePlayer,
                    'ExpectimaxMovePlayer': algorithms.ExpectimaxMovePlayer,
                    }

    index_players = {'RandomIndexPlayer': algorithms.RandomIndexPlayer,
    ...
    # for debuging: change the default algo
    # MiniMaxMovePlayer
    # ABMovePlayer
